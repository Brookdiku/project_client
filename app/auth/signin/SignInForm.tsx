...
const SignInForm: React.FC<SignInFormProps> = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background flex items-center justify-center">
      <Toast message={resposeMessage} flag={flag} type={type} />
      <div className="w-full h-full md:w-3/4 lg:w-1/2 xl:w-2/3 2xl:w-1/2 flex flex-col md:flex-row gap-4">
        <div className="w-full md:w-1/2 bg-blue-500 p-4 rounded-l-sm"></div>
        <div className="w-full md:w-1/2 p-4 rounded-r-sm flex flex-col gap-2">
          <p className="text-2xl text-center font-bold text-blue-500">ACMERA</p>
          <Input
            errorMessage={phoneErrorMessage}
            key="phone"
